...
void LinkedListTester :: testListBasics()
{
    ...
    cout << "This loop should print for 4 lines"<< endl;
...
void LinkedListTester :: testListWithData()
{
    ...
    LinkedList<CrimeData> crimes = FileController :: readDataToList("/Users/ajon6781/Documents/Afternoon Swift/DataStructureProject/DataStructureProject/Data/crime.csv");
    listTimer.stopTimer();
    cout << "This is how long it took to read the strucutre into our custom data structure" << endl;
    listTimer.displayInformation();
    
    listTimer.resetTimer();
    cout << "Here ishow long it takes to access a random data value" << endl;
    listTimer.startTimer();
